...
class StagingTransitSeeder extends StagingSeed
{
  ...
  private function seedRoute(string $cityId, array $spec, \Illuminate\Support\Collection $owners): int
  {
   ...
   */
  private function seedDrafts(?\App\Models\User $transitAdmin, \Illuminate\Support\Collection $owners, $out): void
  {
  ...
  private function seedLogs(?\App\Models\User $transitAdmin, $out): void
  {
    $logs = [
   ...
   */
  private function backdate(\Illuminate\Database\Eloquent\Model $row): void
  {
