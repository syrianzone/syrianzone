export const aboutMarkdown = `# Syrian Zone Project
...
/*
PORT STATUS
  source:     resources/js/Data/about.md (49 lines)
  confidence: high
  todos:      0
  notes:      Bundled as typed source text for the allowlisted native parser.
*/
